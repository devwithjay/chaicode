...
export const WhyChaiCodeCard = ({
  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-xl border border-[var(--border-primary)] bg-[var(--surface-secondary)] p-6 shadow-md hover:border-[var(--text-brand)] hover:shadow-lg">
          ...
          {Object.entries(socialLinks).map(([platform, url]) => {
            ...
            return (
              <a
                ...
                className="text-[var(--text-brand)] hover:text-[var(--surface-brand-hover)]"
              >
