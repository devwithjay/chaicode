...
const TopicsCloud = () => {
  return (
    <section className="mx-auto flex max-w-[1440px] flex-col items-center justify-center bg-[var(--surface-primary)] px-4 pt-6 md:px-8 md:pt-10 lg:pt-18 2xl:px-0">
      ...
      <div className="mt-18 mb-6 flex cursor-pointer flex-wrap justify-center gap-4 md:gap-6 lg:gap-8">
