      ...
      <div className="space-y-12 text-sm leading-relaxed text-[var(--text-primary)] md:text-base lg:text-lg">
        <section className="space-y-4">
          ...
          <p>
            ...
            terms. Most importantly, we do not sell your data to any third
            party. And our platform does not allow users to share accounts or
            resell courses.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-lg font-medium">How do you get my consent?</p>
          <p>
          ...
          <p className="text-lg font-medium">How do I withdraw my consent?</p>
          <p>
            ...
            or mailing us at: 507, AB Nirman nagar, Ajmer Road, Jaipur,
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            that you read their privacy policies to understand how your personal
          ...
          <p>
            ...
            this Privacy Policy or our website's Terms of Service. We are not
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            on the website. If our store is acquired or merged with another
        ...
        <section className="space-y-4">
          ...
          <p>
            To access, correct, amend or delete any personal information we have
            ...
            or mail us at: 507, AB Nirman nagar, Ajmer Road, Jaipur, Rajasthan
            302019, India.
          </p>
        </section>
      </div>
